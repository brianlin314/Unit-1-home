...
if __name__ == '__main__':
    ...
    # all
    # ['DDoS_LOIC-HTTP', 'DDoS_HOIC', 'DDoS_LOIC-UDP', 'DoS_SlowHTTPTest', 'DoS_Slowloris', 'DoS_Hulk', 'DoS_GoldenEye', 'BruteForce-XSS', 'BruteForce-Web', 'SQL-Injection', 'BruteForce-SSH', 'BruteForce-FTP', 'Infiltration', 'Botnet']
    seen_attack_name = ['DDoS_LOIC-UDP', 'DoS_Slowloris', 'DoS_SlowHTTPTest', 'DoS_Hulk', 'DoS_GoldenEye',
    'BruteForce-XSS', 'BruteForce-Web', 'DDoS_LOIC-HTTP', 'BruteForce-SSH', 'BruteForce-FTP', 'Infiltration', 'Botnet'
    ]
    
    unseen_attack_name = ['DDoS_HOIC', 'SQL-Injection']
